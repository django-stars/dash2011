...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Shout'
        db.create_table('shout_shout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shouts', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('is_private', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('shout', ['Shout'])

        # Adding M2M table for field mentions on 'Shout'
        db.create_table('shout_shout_mentions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shout', models.ForeignKey(orm['shout.shout'], null=False)),
