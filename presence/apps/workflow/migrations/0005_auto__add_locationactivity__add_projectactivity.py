...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workflow_locationactivity', (
            ...
            ('new_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_location_activity', to=orm['workflow.State'])),
            ('old_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_location_activity', to=orm['workflow.State'])),
        ...
        db.create_table('workflow_projectactivity', (
            ...
            ('old_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_project_activity', to=orm['workflow.Project'])),
    ...
    models = {
        ...
        'workflow.locationactivity': {
            ...
            'new_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'new_location_activity'", 'to': "orm['workflow.State']"}),
            'old_location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_location_activity'", 'to': "orm['workflow.State']"}),
        ...
        'workflow.projectactivity': {
            ...
            'old_project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_project_activity'", 'to': "orm['workflow.Project']"}),
