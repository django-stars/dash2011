...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'State.usual_duration'
        db.add_column('workflow_state', 'usual_duration', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'State.max_duration'
        db.add_column('workflow_state', 'max_duration', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'State.usual_duration'
        db.delete_column('workflow_state', 'usual_duration')

        # Deleting field 'State.max_duration'
        db.delete_column('workflow_state', 'max_duration')
